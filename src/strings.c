...
const u8 gText_BirchKyle[] = _("KYLE");
const u8 gText_BirchBren[] = _("BREN");
const u8 gText_BirchSpencer[] = _("SPENCER");
...
const u8 gText_MatchCallSpencer_Strategy[] = _("Play to your strengths.");
const u8 gText_MatchCallSpencer_Pokemon[] = _("A team you love is best.");
const u8 gText_MatchCallSpencer_Intro1[] = _("My friends are");
const u8 gText_MatchCallSpencer_Intro2[] = _("my strength!");
const u8 gText_MatchCallBren_Strategy[] = _("Overpower your opponent!");
const u8 gText_MatchCallBren_Pokemon[] = _("Overwhelming strength!");
const u8 gText_MatchCallBren_Intro1[] = _("I'll achieve my dreams-");
const u8 gText_MatchCallBren_Intro2[] = _("no matter what!");
const u8 gText_MatchCallKyle_Strategy[] = _("Patience is key.");
const u8 gText_MatchCallKyle_Pokemon[] = _("A balanced team is best.");
const u8 gText_MatchCallKyle_Intro1[] = _("Slow and steady");
const u8 gText_MatchCallKyle_Intro2[] = _("is how I win.");
...
const u8 gText_MayBrendanMatchCallDesc[] = _("BEST FRIEND");
