...
static const u16 sRivalAvatarGfxIds[][3] =
{
    [PLAYER_AVATAR_STATE_NORMAL]     = {OBJ_EVENT_GFX_KYLE_NORMAL,     OBJ_EVENT_GFX_BRENDAN_NORMAL,     OBJ_EVENT_GFX_SPENCER_NORMAL},
    [PLAYER_AVATAR_STATE_MACH_BIKE]  = {OBJ_EVENT_GFX_KYLE_MACH_BIKE,  OBJ_EVENT_GFX_BRENDAN_MACH_BIKE,  OBJ_EVENT_GFX_SPENCER_MACH_BIKE},
    [PLAYER_AVATAR_STATE_ACRO_BIKE]  = {OBJ_EVENT_GFX_KYLE_ACRO_BIKE,  OBJ_EVENT_GFX_BRENDAN_ACRO_BIKE,  OBJ_EVENT_GFX_SPENCER_ACRO_BIKE},
    [PLAYER_AVATAR_STATE_SURFING]    = {OBJ_EVENT_GFX_KYLE_SURFING,    OBJ_EVENT_GFX_BRENDAN_SURFING,    OBJ_EVENT_GFX_SPENCER_SURFING},
    [PLAYER_AVATAR_STATE_UNDERWATER] = {OBJ_EVENT_GFX_KYLE_UNDERWATER, OBJ_EVENT_GFX_BRENDAN_UNDERWATER, OBJ_EVENT_GFX_SPENCER_UNDERWATER},
    [PLAYER_AVATAR_STATE_FIELD_MOVE] = {OBJ_EVENT_GFX_KYLE_FIELD_MOVE, OBJ_EVENT_GFX_BRENDAN_FIELD_MOVE, OBJ_EVENT_GFX_SPENCER_FIELD_MOVE},
    [PLAYER_AVATAR_STATE_FISHING]    = {OBJ_EVENT_GFX_KYLE_FISHING,    OBJ_EVENT_GFX_BRENDAN_FISHING,    OBJ_EVENT_GFX_SPENCER_FISHING},
    [PLAYER_AVATAR_STATE_WATERING]   = {OBJ_EVENT_GFX_KYLE_WATERING,   OBJ_EVENT_GFX_BRENDAN_WATERING,   OBJ_EVENT_GFX_SPENCER_WATERING},
    [PLAYER_AVATAR_STATE_VSSEEKER]   = {OBJ_EVENT_GFX_KYLE_FIELD_MOVE, OBJ_EVENT_GFX_BRENDAN_FIELD_MOVE, OBJ_EVENT_GFX_SPENCER_FIELD_MOVE},
};

static const u16 sPlayerAvatarGfxIds[][3] =
{
    [PLAYER_AVATAR_STATE_NORMAL]     = {OBJ_EVENT_GFX_KYLE_NORMAL,     OBJ_EVENT_GFX_BREN_NORMAL,     OBJ_EVENT_GFX_SPENCER_NORMAL},
    [PLAYER_AVATAR_STATE_MACH_BIKE]  = {OBJ_EVENT_GFX_KYLE_MACH_BIKE,  OBJ_EVENT_GFX_BREN_MACH_BIKE,  OBJ_EVENT_GFX_SPENCER_MACH_BIKE},
    [PLAYER_AVATAR_STATE_ACRO_BIKE]  = {OBJ_EVENT_GFX_KYLE_ACRO_BIKE,  OBJ_EVENT_GFX_BREN_ACRO_BIKE,  OBJ_EVENT_GFX_SPENCER_ACRO_BIKE},
    [PLAYER_AVATAR_STATE_SURFING]    = {OBJ_EVENT_GFX_KYLE_SURFING,    OBJ_EVENT_GFX_BREN_SURFING,    OBJ_EVENT_GFX_SPENCER_SURFING},
    [PLAYER_AVATAR_STATE_UNDERWATER] = {OBJ_EVENT_GFX_KYLE_UNDERWATER, OBJ_EVENT_GFX_BREN_UNDERWATER, OBJ_EVENT_GFX_SPENCER_UNDERWATER},
    [PLAYER_AVATAR_STATE_FIELD_MOVE] = {OBJ_EVENT_GFX_KYLE_FIELD_MOVE, OBJ_EVENT_GFX_BREN_FIELD_MOVE, OBJ_EVENT_GFX_SPENCER_FIELD_MOVE},
    [PLAYER_AVATAR_STATE_FISHING]    = {OBJ_EVENT_GFX_KYLE_FISHING,    OBJ_EVENT_GFX_BREN_FISHING,    OBJ_EVENT_GFX_SPENCER_FISHING},
    [PLAYER_AVATAR_STATE_WATERING]   = {OBJ_EVENT_GFX_KYLE_WATERING,   OBJ_EVENT_GFX_BREN_WATERING,   OBJ_EVENT_GFX_SPENCER_WATERING},
    [PLAYER_AVATAR_STATE_VSSEEKER]   = {OBJ_EVENT_GFX_KYLE_FIELD_MOVE, OBJ_EVENT_GFX_BREN_FIELD_MOVE, OBJ_EVENT_GFX_SPENCER_FIELD_MOVE},
};

static const u8 sFRLGAvatarGfxIds[FRIEND_COUNT] =
{
    [KYLE]   = OBJ_EVENT_GFX_RED,
    [BREN] = OBJ_EVENT_GFX_RED,
    [SPENCER] = OBJ_EVENT_GFX_RED
};

static const u8 sRSAvatarGfxIds[FRIEND_COUNT] =
{
    [KYLE]   = OBJ_EVENT_GFX_KYLE_NORMAL,
    [BREN] = OBJ_EVENT_GFX_BREN_NORMAL,
    [SPENCER] = OBJ_EVENT_GFX_SPENCER_NORMAL
};

static const u8 sPlayerAvatarGfxToStateFlag[FRIEND_COUNT][5][2] =
{
    [KYLE] =
    {
        {OBJ_EVENT_GFX_KYLE_NORMAL,     PLAYER_AVATAR_FLAG_ON_FOOT},
        {OBJ_EVENT_GFX_KYLE_MACH_BIKE,  PLAYER_AVATAR_FLAG_MACH_BIKE},
        {OBJ_EVENT_GFX_KYLE_ACRO_BIKE,  PLAYER_AVATAR_FLAG_ACRO_BIKE},
        {OBJ_EVENT_GFX_KYLE_SURFING,    PLAYER_AVATAR_FLAG_SURFING},
        {OBJ_EVENT_GFX_KYLE_UNDERWATER, PLAYER_AVATAR_FLAG_UNDERWATER},
    },
    [BREN] =
    {
        {OBJ_EVENT_GFX_BREN_NORMAL,         PLAYER_AVATAR_FLAG_ON_FOOT},
        {OBJ_EVENT_GFX_BREN_MACH_BIKE,      PLAYER_AVATAR_FLAG_MACH_BIKE},
        {OBJ_EVENT_GFX_BREN_ACRO_BIKE,      PLAYER_AVATAR_FLAG_ACRO_BIKE},
        {OBJ_EVENT_GFX_BREN_SURFING,        PLAYER_AVATAR_FLAG_SURFING},
        {OBJ_EVENT_GFX_BREN_UNDERWATER,     PLAYER_AVATAR_FLAG_UNDERWATER},
    },
    [SPENCER] =
    {
        {OBJ_EVENT_GFX_SPENCER_NORMAL,         PLAYER_AVATAR_FLAG_ON_FOOT},
        {OBJ_EVENT_GFX_SPENCER_MACH_BIKE,      PLAYER_AVATAR_FLAG_MACH_BIKE},
        {OBJ_EVENT_GFX_SPENCER_ACRO_BIKE,      PLAYER_AVATAR_FLAG_ACRO_BIKE},
        {OBJ_EVENT_GFX_SPENCER_SURFING,        PLAYER_AVATAR_FLAG_SURFING},
        {OBJ_EVENT_GFX_SPENCER_UNDERWATER,     PLAYER_AVATAR_FLAG_UNDERWATER},
    }
};
...
u8 GetPlayerAvatarGenderByGraphicsId(u16 gfxId)
{
    switch (gfxId)
    {
    case OBJ_EVENT_GFX_KYLE_NORMAL:
    case OBJ_EVENT_GFX_KYLE_MACH_BIKE:
    case OBJ_EVENT_GFX_KYLE_ACRO_BIKE:
    case OBJ_EVENT_GFX_KYLE_SURFING:
    case OBJ_EVENT_GFX_KYLE_FIELD_MOVE:
    case OBJ_EVENT_GFX_KYLE_UNDERWATER:
    case OBJ_EVENT_GFX_KYLE_FISHING:
    case OBJ_EVENT_GFX_KYLE_WATERING:
        return KYLE;
    case OBJ_EVENT_GFX_BREN_NORMAL:
    case OBJ_EVENT_GFX_BREN_MACH_BIKE:
    case OBJ_EVENT_GFX_BREN_ACRO_BIKE:
    case OBJ_EVENT_GFX_BREN_SURFING:
    case OBJ_EVENT_GFX_BREN_FIELD_MOVE:
    case OBJ_EVENT_GFX_BREN_UNDERWATER:
    case OBJ_EVENT_GFX_BREN_FISHING:
    case OBJ_EVENT_GFX_BREN_WATERING:
        return BREN;
    default:
        return SPENCER;
    }
