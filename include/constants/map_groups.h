...
#define MAP_GROUP_32_COUNT    3

// gMapGroup_IndoorRoute124
#define MAP_ROUTE124_DIVING_TREASURE_HUNTERS_HOUSE (0 | (33 << 8))
#define MAP_GROUP_33_COUNT    1

#define MAP_GROUPS_COUNT 34

enum {
    CM_MAP_PETALBURG_CITY,
    CM_MAP_SLATEPORT_CITY,
    CM_MAP_MAUVILLE_CITY,
    CM_MAP_RUSTBORO_CITY,
    CM_MAP_FORTREE_CITY,
    CM_MAP_LILYCOVE_CITY,
    CM_MAP_MOSSDEEP_CITY,
    CM_MAP_SOOTOPOLIS_CITY,
    CM_MAP_EVER_GRANDE_CITY,
    CM_MAP_LITTLEROOT_TOWN,
    CM_MAP_OLDALE_TOWN,
    CM_MAP_DEWFORD_TOWN,
    CM_MAP_LAVARIDGE_TOWN,
    CM_MAP_FALLARBOR_TOWN,
    CM_MAP_VERDANTURF_TOWN,
    CM_MAP_PACIFIDLOG_TOWN,
    CM_MAP_ROUTE101,
    CM_MAP_ROUTE102,
    CM_MAP_ROUTE103,
    CM_MAP_ROUTE104,
    ...
    CM_MAP_ROUTE133,
    CM_MAP_ROUTE134,
    CM_MAP_UNDERWATER_ROUTE124,
    CM_MAP_UNDERWATER_ROUTE126,
    CM_MAP_UNDERWATER_ROUTE127,
    CM_MAP_UNDERWATER_ROUTE128,
    CM_MAP_UNDERWATER_ROUTE129,
    CM_MAP_UNDERWATER_ROUTE105,
    CM_MAP_UNDERWATER_ROUTE125,
    CM_MAP_LITTLEROOT_TOWN_BRENDANS_HOUSE_1F,
    CM_MAP_LITTLEROOT_TOWN_BRENDANS_HOUSE_2F,
    CM_MAP_LITTLEROOT_TOWN_MAYS_HOUSE_1F,
    CM_MAP_LITTLEROOT_TOWN_MAYS_HOUSE_2F,
    CM_MAP_LITTLEROOT_TOWN_PROFESSOR_BIRCHS_LAB,
    CM_MAP_OLDALE_TOWN_HOUSE1,
    CM_MAP_OLDALE_TOWN_HOUSE2,
    CM_MAP_OLDALE_TOWN_POKEMON_CENTER_1F,
    CM_MAP_OLDALE_TOWN_POKEMON_CENTER_2F,
    CM_MAP_OLDALE_TOWN_MART,
    CM_MAP_DEWFORD_TOWN_HOUSE1,
    CM_MAP_DEWFORD_TOWN_POKEMON_CENTER_1F,
    CM_MAP_DEWFORD_TOWN_POKEMON_CENTER_2F,
    CM_MAP_DEWFORD_TOWN_GYM,
    CM_MAP_DEWFORD_TOWN_HALL,
    CM_MAP_DEWFORD_TOWN_HOUSE2,
    CM_MAP_LAVARIDGE_TOWN_HERB_SHOP,
    CM_MAP_LAVARIDGE_TOWN_GYM_1F,
    CM_MAP_LAVARIDGE_TOWN_GYM_B1F,
    CM_MAP_LAVARIDGE_TOWN_HOUSE,
    CM_MAP_LAVARIDGE_TOWN_MART,
    CM_MAP_LAVARIDGE_TOWN_POKEMON_CENTER_1F,
    CM_MAP_LAVARIDGE_TOWN_POKEMON_CENTER_2F,
    CM_MAP_FALLARBOR_TOWN_MART,
    CM_MAP_FALLARBOR_TOWN_BATTLE_TENT_LOBBY,
    CM_MAP_FALLARBOR_TOWN_BATTLE_TENT_CORRIDOR,
    CM_MAP_FALLARBOR_TOWN_BATTLE_TENT_BATTLE_ROOM,
    CM_MAP_FALLARBOR_TOWN_POKEMON_CENTER_1F,
    CM_MAP_FALLARBOR_TOWN_POKEMON_CENTER_2F,
    CM_MAP_FALLARBOR_TOWN_COZMOS_HOUSE,
    CM_MAP_FALLARBOR_TOWN_MOVE_RELEARNERS_HOUSE,
    CM_MAP_VERDANTURF_TOWN_BATTLE_TENT_LOBBY,
    CM_MAP_VERDANTURF_TOWN_BATTLE_TENT_CORRIDOR,
    CM_MAP_VERDANTURF_TOWN_BATTLE_TENT_BATTLE_ROOM,
    CM_MAP_VERDANTURF_TOWN_MART,
    CM_MAP_VERDANTURF_TOWN_POKEMON_CENTER_1F,
    CM_MAP_VERDANTURF_TOWN_POKEMON_CENTER_2F,
    CM_MAP_VERDANTURF_TOWN_WANDAS_HOUSE,
    CM_MAP_VERDANTURF_TOWN_FRIENDSHIP_RATERS_HOUSE,
    CM_MAP_VERDANTURF_TOWN_HOUSE,
    CM_MAP_PACIFIDLOG_TOWN_POKEMON_CENTER_1F,
    CM_MAP_PACIFIDLOG_TOWN_POKEMON_CENTER_2F,
    CM_MAP_PACIFIDLOG_TOWN_HOUSE1,
    CM_MAP_PACIFIDLOG_TOWN_HOUSE2,
    CM_MAP_PACIFIDLOG_TOWN_HOUSE3,
    CM_MAP_PACIFIDLOG_TOWN_HOUSE4,
    CM_MAP_PACIFIDLOG_TOWN_HOUSE5,
    CM_MAP_PETALBURG_CITY_WALLYS_HOUSE,
    CM_MAP_PETALBURG_CITY_GYM,
    CM_MAP_PETALBURG_CITY_HOUSE1,
    CM_MAP_PETALBURG_CITY_HOUSE2,
    CM_MAP_PETALBURG_CITY_POKEMON_CENTER_1F,
    CM_MAP_PETALBURG_CITY_POKEMON_CENTER_2F,
    CM_MAP_PETALBURG_CITY_MART,
    CM_MAP_SLATEPORT_CITY_STERNS_SHIPYARD_1F,
    CM_MAP_SLATEPORT_CITY_STERNS_SHIPYARD_2F,
    CM_MAP_SLATEPORT_CITY_BATTLE_TENT_LOBBY,
    CM_MAP_SLATEPORT_CITY_BATTLE_TENT_CORRIDOR,
    CM_MAP_SLATEPORT_CITY_BATTLE_TENT_BATTLE_ROOM,
    CM_MAP_SLATEPORT_CITY_NAME_RATERS_HOUSE,
    CM_MAP_SLATEPORT_CITY_POKEMON_FAN_CLUB,
    CM_MAP_SLATEPORT_CITY_OCEANIC_MUSEUM_1F,
    CM_MAP_SLATEPORT_CITY_OCEANIC_MUSEUM_2F,
    CM_MAP_SLATEPORT_CITY_HARBOR,
    CM_MAP_SLATEPORT_CITY_HOUSE,
    CM_MAP_SLATEPORT_CITY_POKEMON_CENTER_1F,
    CM_MAP_SLATEPORT_CITY_POKEMON_CENTER_2F,
    CM_MAP_SLATEPORT_CITY_MART,
    CM_MAP_MAUVILLE_CITY_GYM,
    CM_MAP_MAUVILLE_CITY_BIKE_SHOP,
    CM_MAP_MAUVILLE_CITY_HOUSE1,
    CM_MAP_MAUVILLE_CITY_GAME_CORNER,
    CM_MAP_MAUVILLE_CITY_HOUSE2,
    CM_MAP_MAUVILLE_CITY_POKEMON_CENTER_1F,
    CM_MAP_MAUVILLE_CITY_POKEMON_CENTER_2F,
    CM_MAP_MAUVILLE_CITY_MART,
    CM_MAP_RUSTBORO_CITY_DEVON_CORP_1F,
    CM_MAP_RUSTBORO_CITY_DEVON_CORP_2F,
    CM_MAP_RUSTBORO_CITY_DEVON_CORP_3F,
    CM_MAP_RUSTBORO_CITY_GYM,
    CM_MAP_RUSTBORO_CITY_POKEMON_SCHOOL,
    CM_MAP_RUSTBORO_CITY_POKEMON_CENTER_1F,
    CM_MAP_RUSTBORO_CITY_POKEMON_CENTER_2F,
    CM_MAP_RUSTBORO_CITY_MART,
    CM_MAP_RUSTBORO_CITY_FLAT1_1F,
    CM_MAP_RUSTBORO_CITY_FLAT1_2F,
    CM_MAP_RUSTBORO_CITY_HOUSE1,
    CM_MAP_RUSTBORO_CITY_CUTTERS_HOUSE,
    CM_MAP_RUSTBORO_CITY_HOUSE2,
    CM_MAP_RUSTBORO_CITY_FLAT2_1F,
    CM_MAP_RUSTBORO_CITY_FLAT2_2F,
    CM_MAP_RUSTBORO_CITY_FLAT2_3F,
    CM_MAP_RUSTBORO_CITY_HOUSE3,
    CM_MAP_FORTREE_CITY_HOUSE1,
    CM_MAP_FORTREE_CITY_GYM,
    CM_MAP_FORTREE_CITY_POKEMON_CENTER_1F,
    CM_MAP_FORTREE_CITY_POKEMON_CENTER_2F,
    CM_MAP_FORTREE_CITY_MART,
    CM_MAP_FORTREE_CITY_HOUSE2,
    CM_MAP_FORTREE_CITY_HOUSE3,
    CM_MAP_FORTREE_CITY_HOUSE4,
    CM_MAP_FORTREE_CITY_HOUSE5,
    CM_MAP_FORTREE_CITY_DECORATION_SHOP,
    CM_MAP_LILYCOVE_CITY_COVE_LILY_MOTEL_1F,
    CM_MAP_LILYCOVE_CITY_COVE_LILY_MOTEL_2F,
    CM_MAP_LILYCOVE_CITY_LILYCOVE_MUSEUM_1F,
    CM_MAP_LILYCOVE_CITY_LILYCOVE_MUSEUM_2F,
    CM_MAP_LILYCOVE_CITY_CONTEST_LOBBY,
    CM_MAP_LILYCOVE_CITY_CONTEST_HALL,
    CM_MAP_LILYCOVE_CITY_POKEMON_CENTER_1F,
    CM_MAP_LILYCOVE_CITY_POKEMON_CENTER_2F,
    CM_MAP_LILYCOVE_CITY_UNUSED_MART,
    CM_MAP_LILYCOVE_CITY_POKEMON_TRAINER_FAN_CLUB,
    CM_MAP_LILYCOVE_CITY_HARBOR,
    CM_MAP_LILYCOVE_CITY_MOVE_DELETERS_HOUSE,
    CM_MAP_LILYCOVE_CITY_HOUSE1,
    CM_MAP_LILYCOVE_CITY_HOUSE2,
    CM_MAP_LILYCOVE_CITY_HOUSE3,
    CM_MAP_LILYCOVE_CITY_HOUSE4,
    CM_MAP_LILYCOVE_CITY_DEPARTMENT_STORE_1F,
    CM_MAP_LILYCOVE_CITY_DEPARTMENT_STORE_2F,
    CM_MAP_LILYCOVE_CITY_DEPARTMENT_STORE_3F,
    CM_MAP_LILYCOVE_CITY_DEPARTMENT_STORE_4F,
    CM_MAP_LILYCOVE_CITY_DEPARTMENT_STORE_5F,
    CM_MAP_LILYCOVE_CITY_DEPARTMENT_STORE_ROOFTOP,
    CM_MAP_LILYCOVE_CITY_DEPARTMENT_STORE_ELEVATOR,
    CM_MAP_MOSSDEEP_CITY_GYM,
    CM_MAP_MOSSDEEP_CITY_HOUSE1,
    CM_MAP_MOSSDEEP_CITY_HOUSE2,
    CM_MAP_MOSSDEEP_CITY_POKEMON_CENTER_1F,
    CM_MAP_MOSSDEEP_CITY_POKEMON_CENTER_2F,
    CM_MAP_MOSSDEEP_CITY_MART,
    CM_MAP_MOSSDEEP_CITY_HOUSE3,
    CM_MAP_MOSSDEEP_CITY_STEVENS_HOUSE,
    CM_MAP_MOSSDEEP_CITY_HOUSE4,
    CM_MAP_MOSSDEEP_CITY_SPACE_CENTER_1F,
    CM_MAP_MOSSDEEP_CITY_SPACE_CENTER_2F,
    CM_MAP_MOSSDEEP_CITY_GAME_CORNER_1F,
    CM_MAP_MOSSDEEP_CITY_GAME_CORNER_B1F,
    CM_MAP_SOOTOPOLIS_CITY_GYM_1F,
    CM_MAP_SOOTOPOLIS_CITY_GYM_B1F,
    CM_MAP_SOOTOPOLIS_CITY_POKEMON_CENTER_1F,
    CM_MAP_SOOTOPOLIS_CITY_POKEMON_CENTER_2F,
    CM_MAP_SOOTOPOLIS_CITY_MART,
    CM_MAP_SOOTOPOLIS_CITY_HOUSE1,
    CM_MAP_SOOTOPOLIS_CITY_HOUSE2,
    CM_MAP_SOOTOPOLIS_CITY_HOUSE3,
    CM_MAP_SOOTOPOLIS_CITY_HOUSE4,
    CM_MAP_SOOTOPOLIS_CITY_HOUSE5,
    CM_MAP_SOOTOPOLIS_CITY_HOUSE6,
    CM_MAP_SOOTOPOLIS_CITY_HOUSE7,
    CM_MAP_SOOTOPOLIS_CITY_LOTAD_AND_SEEDOT_HOUSE,
    CM_MAP_SOOTOPOLIS_CITY_MYSTERY_EVENTS_HOUSE_1F,
    CM_MAP_SOOTOPOLIS_CITY_MYSTERY_EVENTS_HOUSE_B1F,
    CM_MAP_EVER_GRANDE_CITY_SIDNEYS_ROOM,
    CM_MAP_EVER_GRANDE_CITY_PHOEBES_ROOM,
    CM_MAP_EVER_GRANDE_CITY_GLACIAS_ROOM,
    CM_MAP_EVER_GRANDE_CITY_DRAKES_ROOM,
    CM_MAP_EVER_GRANDE_CITY_CHAMPIONS_ROOM,
    CM_MAP_EVER_GRANDE_CITY_HALL1,
    CM_MAP_EVER_GRANDE_CITY_HALL2,
    CM_MAP_EVER_GRANDE_CITY_HALL3,
    CM_MAP_EVER_GRANDE_CITY_HALL4,
    CM_MAP_EVER_GRANDE_CITY_HALL5,
    CM_MAP_EVER_GRANDE_CITY_POKEMON_LEAGUE_1F,
    CM_MAP_EVER_GRANDE_CITY_HALL_OF_FAME,
    CM_MAP_EVER_GRANDE_CITY_POKEMON_CENTER_1F,
    CM_MAP_EVER_GRANDE_CITY_POKEMON_CENTER_2F,
    CM_MAP_EVER_GRANDE_CITY_POKEMON_LEAGUE_2F,
    CM_MAP_ROUTE104_MR_BRINEYS_HOUSE,
    CM_MAP_ROUTE104_PRETTY_PETAL_FLOWER_SHOP,
    CM_MAP_ROUTE111_WINSTRATE_FAMILYS_HOUSE,
    CM_MAP_ROUTE111_OLD_LADYS_REST_STOP,
    CM_MAP_ROUTE112_CABLE_CAR_STATION,
    CM_MAP_MT_CHIMNEY_CABLE_CAR_STATION,
    CM_MAP_ROUTE114_FOSSIL_MANIACS_HOUSE,
    CM_MAP_ROUTE114_FOSSIL_MANIACS_TUNNEL,
    CM_MAP_ROUTE114_LANETTES_HOUSE,
    CM_MAP_ROUTE116_TUNNELERS_REST_HOUSE,
    CM_MAP_ROUTE117_POKEMON_DAY_CARE,
    CM_MAP_ROUTE121_SAFARI_ZONE_ENTRANCE,
    CM_MAP_METEOR_FALLS_1F_1R,
    CM_MAP_METEOR_FALLS_1F_2R,
    CM_MAP_METEOR_FALLS_B1F_1R,
    CM_MAP_METEOR_FALLS_B1F_2R,
    CM_MAP_RUSTURF_TUNNEL,
    CM_MAP_UNDERWATER_SOOTOPOLIS_CITY,
    CM_MAP_DESERT_RUINS,
    CM_MAP_GRANITE_CAVE_1F,
    CM_MAP_GRANITE_CAVE_B1F,
    CM_MAP_GRANITE_CAVE_B2F,
    CM_MAP_GRANITE_CAVE_STEVENS_ROOM,
    CM_MAP_PETALBURG_WOODS,
    CM_MAP_MT_CHIMNEY,
    CM_MAP_JAGGED_PASS,
    CM_MAP_FIERY_PATH,
    CM_MAP_MT_PYRE_1F,
    ...
    CM_MAP_MT_PYRE_5F,
    CM_MAP_MT_PYRE_6F,
    CM_MAP_MT_PYRE_EXTERIOR,
    CM_MAP_MT_PYRE_SUMMIT,
    CM_MAP_AQUA_HIDEOUT_1F,
    CM_MAP_AQUA_HIDEOUT_B1F,
    CM_MAP_AQUA_HIDEOUT_B2F,
    CM_MAP_UNDERWATER_SEAFLOOR_CAVERN,
    CM_MAP_SEAFLOOR_CAVERN_ENTRANCE,
    CM_MAP_SEAFLOOR_CAVERN_ROOM1,
    CM_MAP_SEAFLOOR_CAVERN_ROOM2,
    CM_MAP_SEAFLOOR_CAVERN_ROOM3,
    CM_MAP_SEAFLOOR_CAVERN_ROOM4,
    CM_MAP_SEAFLOOR_CAVERN_ROOM5,
    CM_MAP_SEAFLOOR_CAVERN_ROOM6,
    CM_MAP_SEAFLOOR_CAVERN_ROOM7,
    CM_MAP_SEAFLOOR_CAVERN_ROOM8,
    CM_MAP_SEAFLOOR_CAVERN_ROOM9,
    CM_MAP_CAVE_OF_ORIGIN_ENTRANCE,
    CM_MAP_CAVE_OF_ORIGIN_1F,
    CM_MAP_CAVE_OF_ORIGIN_UNUSED_RUBY_SAPPHIRE_MAP1,
    CM_MAP_CAVE_OF_ORIGIN_UNUSED_RUBY_SAPPHIRE_MAP2,
    CM_MAP_CAVE_OF_ORIGIN_UNUSED_RUBY_SAPPHIRE_MAP3,
    CM_MAP_CAVE_OF_ORIGIN_B1F,
    CM_MAP_VICTORY_ROAD_1F,
    CM_MAP_VICTORY_ROAD_B1F,
    CM_MAP_VICTORY_ROAD_B2F,
    CM_MAP_SHOAL_CAVE_LOW_TIDE_ENTRANCE_ROOM,
    CM_MAP_SHOAL_CAVE_LOW_TIDE_INNER_ROOM,
    CM_MAP_SHOAL_CAVE_LOW_TIDE_STAIRS_ROOM,
    CM_MAP_SHOAL_CAVE_LOW_TIDE_LOWER_ROOM,
    CM_MAP_SHOAL_CAVE_HIGH_TIDE_ENTRANCE_ROOM,
    CM_MAP_SHOAL_CAVE_HIGH_TIDE_INNER_ROOM,
    CM_MAP_NEW_MAUVILLE_ENTRANCE,
    CM_MAP_NEW_MAUVILLE_INSIDE,
    CM_MAP_ABANDONED_SHIP_DECK,
    CM_MAP_ABANDONED_SHIP_CORRIDORS_1F,
    CM_MAP_ABANDONED_SHIP_ROOMS_1F,
    CM_MAP_ABANDONED_SHIP_CORRIDORS_B1F,
    CM_MAP_ABANDONED_SHIP_ROOMS_B1F,
    CM_MAP_ABANDONED_SHIP_ROOMS2_B1F,
    CM_MAP_ABANDONED_SHIP_UNDERWATER1,
    CM_MAP_ABANDONED_SHIP_ROOM_B1F,
    CM_MAP_ABANDONED_SHIP_ROOMS2_1F,
    CM_MAP_ABANDONED_SHIP_CAPTAINS_OFFICE,
    CM_MAP_ABANDONED_SHIP_UNDERWATER2,
    CM_MAP_ABANDONED_SHIP_HIDDEN_FLOOR_CORRIDORS,
    CM_MAP_ABANDONED_SHIP_HIDDEN_FLOOR_ROOMS,
    CM_MAP_ISLAND_CAVE,
    CM_MAP_ANCIENT_TOMB,
    CM_MAP_UNDERWATER_ROUTE134,
    CM_MAP_UNDERWATER_SEALED_CHAMBER,
    CM_MAP_SEALED_CHAMBER_OUTER_ROOM,
    CM_MAP_SEALED_CHAMBER_INNER_ROOM,
    CM_MAP_SCORCHED_SLAB,
    CM_MAP_AQUA_HIDEOUT_UNUSED_RUBY_MAP1,
    CM_MAP_AQUA_HIDEOUT_UNUSED_RUBY_MAP2,
    CM_MAP_AQUA_HIDEOUT_UNUSED_RUBY_MAP3,
    CM_MAP_SKY_PILLAR_ENTRANCE,
    CM_MAP_SKY_PILLAR_OUTSIDE,
    CM_MAP_SKY_PILLAR_1F,
    CM_MAP_SKY_PILLAR_2F,
    CM_MAP_SKY_PILLAR_3F,
    CM_MAP_SKY_PILLAR_4F,
    CM_MAP_SHOAL_CAVE_LOW_TIDE_ICE_ROOM,
    CM_MAP_SKY_PILLAR_5F,
    CM_MAP_SKY_PILLAR_TOP,
    CM_MAP_MAGMA_HIDEOUT_1F,
    CM_MAP_MAGMA_HIDEOUT_2F_1R,
    CM_MAP_MAGMA_HIDEOUT_2F_2R,
    CM_MAP_MAGMA_HIDEOUT_3F_1R,
    CM_MAP_MAGMA_HIDEOUT_3F_2R,
    CM_MAP_MAGMA_HIDEOUT_4F,
    CM_MAP_MAGMA_HIDEOUT_3F_3R,
    CM_MAP_MAGMA_HIDEOUT_2F_3R,
    CM_MAP_MIRAGE_TOWER_1F,
    CM_MAP_MIRAGE_TOWER_2F,
    CM_MAP_MIRAGE_TOWER_3F,
    CM_MAP_MIRAGE_TOWER_4F,
    CM_MAP_DESERT_UNDERPASS,
    CM_MAP_ARTISAN_CAVE_B1F,
    CM_MAP_ARTISAN_CAVE_1F,
    CM_MAP_UNDERWATER_MARINE_CAVE,
    CM_MAP_MARINE_CAVE_ENTRANCE,
    CM_MAP_MARINE_CAVE_END,
    CM_MAP_TERRA_CAVE_ENTRANCE,
    CM_MAP_TERRA_CAVE_END,
    CM_MAP_ALTERING_CAVE,
    CM_MAP_METEOR_FALLS_STEVENS_CAVE,
    CM_MAP_SECRET_BASE_RED_CAVE1,
    CM_MAP_SECRET_BASE_BROWN_CAVE1,
    CM_MAP_SECRET_BASE_BLUE_CAVE1,
    CM_MAP_SECRET_BASE_YELLOW_CAVE1,
    CM_MAP_SECRET_BASE_TREE1,
    CM_MAP_SECRET_BASE_SHRUB1,
    CM_MAP_SECRET_BASE_RED_CAVE2,
    CM_MAP_SECRET_BASE_BROWN_CAVE2,
    CM_MAP_SECRET_BASE_BLUE_CAVE2,
    CM_MAP_SECRET_BASE_YELLOW_CAVE2,
    CM_MAP_SECRET_BASE_TREE2,
    CM_MAP_SECRET_BASE_SHRUB2,
    CM_MAP_SECRET_BASE_RED_CAVE3,
    CM_MAP_SECRET_BASE_BROWN_CAVE3,
    CM_MAP_SECRET_BASE_BLUE_CAVE3,
    CM_MAP_SECRET_BASE_YELLOW_CAVE3,
    CM_MAP_SECRET_BASE_TREE3,
    CM_MAP_SECRET_BASE_SHRUB3,
    CM_MAP_SECRET_BASE_RED_CAVE4,
    CM_MAP_SECRET_BASE_BROWN_CAVE4,
    CM_MAP_SECRET_BASE_BLUE_CAVE4,
    CM_MAP_SECRET_BASE_YELLOW_CAVE4,
    CM_MAP_SECRET_BASE_TREE4,
    CM_MAP_SECRET_BASE_SHRUB4,
    CM_MAP_BATTLE_COLOSSEUM_2P,
    CM_MAP_TRADE_CENTER,
    CM_MAP_RECORD_CORNER,
    CM_MAP_BATTLE_COLOSSEUM_4P,
    CM_MAP_CONTEST_HALL,
    CM_MAP_UNUSED_CONTEST_HALL1,
    CM_MAP_UNUSED_CONTEST_HALL2,
    CM_MAP_UNUSED_CONTEST_HALL3,
    CM_MAP_UNUSED_CONTEST_HALL4,
    CM_MAP_UNUSED_CONTEST_HALL5,
    CM_MAP_UNUSED_CONTEST_HALL6,
    CM_MAP_CONTEST_HALL_BEAUTY,
    CM_MAP_CONTEST_HALL_TOUGH,
    CM_MAP_CONTEST_HALL_COOL,
    CM_MAP_CONTEST_HALL_SMART,
    CM_MAP_CONTEST_HALL_CUTE,
    CM_MAP_INSIDE_OF_TRUCK,
    CM_MAP_SS_TIDAL_CORRIDOR,
    CM_MAP_SS_TIDAL_LOWER_DECK,
    CM_MAP_SS_TIDAL_ROOMS,
    CM_MAP_BATTLE_PYRAMID_SQUARE01,
    CM_MAP_BATTLE_PYRAMID_SQUARE02,
    CM_MAP_BATTLE_PYRAMID_SQUARE03,
    CM_MAP_BATTLE_PYRAMID_SQUARE04,
    CM_MAP_BATTLE_PYRAMID_SQUARE05,
    CM_MAP_BATTLE_PYRAMID_SQUARE06,
    CM_MAP_BATTLE_PYRAMID_SQUARE07,
    CM_MAP_BATTLE_PYRAMID_SQUARE08,
    CM_MAP_BATTLE_PYRAMID_SQUARE09,
    CM_MAP_BATTLE_PYRAMID_SQUARE10,
    CM_MAP_BATTLE_PYRAMID_SQUARE11,
    CM_MAP_BATTLE_PYRAMID_SQUARE12,
    CM_MAP_BATTLE_PYRAMID_SQUARE13,
    CM_MAP_BATTLE_PYRAMID_SQUARE14,
    CM_MAP_BATTLE_PYRAMID_SQUARE15,
    CM_MAP_BATTLE_PYRAMID_SQUARE16,
    CM_MAP_UNION_ROOM,
    CM_MAP_SAFARI_ZONE_NORTHWEST,
    CM_MAP_SAFARI_ZONE_NORTH,
    CM_MAP_SAFARI_ZONE_SOUTHWEST,
    CM_MAP_SAFARI_ZONE_SOUTH,
    CM_MAP_BATTLE_FRONTIER_OUTSIDE_WEST,
    CM_MAP_BATTLE_FRONTIER_BATTLE_TOWER_LOBBY,
    CM_MAP_BATTLE_FRONTIER_BATTLE_TOWER_ELEVATOR,
    CM_MAP_BATTLE_FRONTIER_BATTLE_TOWER_CORRIDOR,
    CM_MAP_BATTLE_FRONTIER_BATTLE_TOWER_BATTLE_ROOM,
    CM_MAP_SOUTHERN_ISLAND_EXTERIOR,
    CM_MAP_SOUTHERN_ISLAND_INTERIOR,
    CM_MAP_SAFARI_ZONE_REST_HOUSE,
    CM_MAP_SAFARI_ZONE_NORTHEAST,
    CM_MAP_SAFARI_ZONE_SOUTHEAST,
    CM_MAP_BATTLE_FRONTIER_OUTSIDE_EAST,
    CM_MAP_BATTLE_FRONTIER_BATTLE_TOWER_MULTI_PARTNER_ROOM,
    CM_MAP_BATTLE_FRONTIER_BATTLE_TOWER_MULTI_CORRIDOR,
    CM_MAP_BATTLE_FRONTIER_BATTLE_TOWER_MULTI_BATTLE_ROOM,
    CM_MAP_BATTLE_FRONTIER_BATTLE_DOME_LOBBY,
    CM_MAP_BATTLE_FRONTIER_BATTLE_DOME_CORRIDOR,
    CM_MAP_BATTLE_FRONTIER_BATTLE_DOME_PRE_BATTLE_ROOM,
    CM_MAP_BATTLE_FRONTIER_BATTLE_DOME_BATTLE_ROOM,
    CM_MAP_BATTLE_FRONTIER_BATTLE_PALACE_LOBBY,
    CM_MAP_BATTLE_FRONTIER_BATTLE_PALACE_CORRIDOR,
    CM_MAP_BATTLE_FRONTIER_BATTLE_PALACE_BATTLE_ROOM,
    CM_MAP_BATTLE_FRONTIER_BATTLE_PYRAMID_LOBBY,
    CM_MAP_BATTLE_FRONTIER_BATTLE_PYRAMID_FLOOR,
    CM_MAP_BATTLE_FRONTIER_BATTLE_PYRAMID_TOP,
    CM_MAP_BATTLE_FRONTIER_BATTLE_ARENA_LOBBY,
    CM_MAP_BATTLE_FRONTIER_BATTLE_ARENA_CORRIDOR,
    CM_MAP_BATTLE_FRONTIER_BATTLE_ARENA_BATTLE_ROOM,
    CM_MAP_BATTLE_FRONTIER_BATTLE_FACTORY_LOBBY,
    CM_MAP_BATTLE_FRONTIER_BATTLE_FACTORY_PRE_BATTLE_ROOM,
    CM_MAP_BATTLE_FRONTIER_BATTLE_FACTORY_BATTLE_ROOM,
    CM_MAP_BATTLE_FRONTIER_BATTLE_PIKE_LOBBY,
    CM_MAP_BATTLE_FRONTIER_BATTLE_PIKE_CORRIDOR,
    CM_MAP_BATTLE_FRONTIER_BATTLE_PIKE_THREE_PATH_ROOM,
    CM_MAP_BATTLE_FRONTIER_BATTLE_PIKE_ROOM_NORMAL,
    CM_MAP_BATTLE_FRONTIER_BATTLE_PIKE_ROOM_FINAL,
    CM_MAP_BATTLE_FRONTIER_BATTLE_PIKE_ROOM_WILD_MONS,
    CM_MAP_BATTLE_FRONTIER_RANKING_HALL,
    CM_MAP_BATTLE_FRONTIER_LOUNGE1,
    CM_MAP_BATTLE_FRONTIER_EXCHANGE_SERVICE_CORNER,
    CM_MAP_BATTLE_FRONTIER_LOUNGE2,
    CM_MAP_BATTLE_FRONTIER_LOUNGE3,
    CM_MAP_BATTLE_FRONTIER_LOUNGE4,
    CM_MAP_BATTLE_FRONTIER_SCOTTS_HOUSE,
    CM_MAP_BATTLE_FRONTIER_LOUNGE5,
    CM_MAP_BATTLE_FRONTIER_LOUNGE6,
    CM_MAP_BATTLE_FRONTIER_LOUNGE7,
    CM_MAP_BATTLE_FRONTIER_RECEPTION_GATE,
    CM_MAP_BATTLE_FRONTIER_LOUNGE8,
    CM_MAP_BATTLE_FRONTIER_LOUNGE9,
    CM_MAP_BATTLE_FRONTIER_POKEMON_CENTER_1F,
    CM_MAP_BATTLE_FRONTIER_POKEMON_CENTER_2F,
    CM_MAP_BATTLE_FRONTIER_MART,
    CM_MAP_FARAWAY_ISLAND_ENTRANCE,
    CM_MAP_FARAWAY_ISLAND_INTERIOR,
    CM_MAP_BIRTH_ISLAND_EXTERIOR,
    CM_MAP_BIRTH_ISLAND_HARBOR,
    CM_MAP_TRAINER_HILL_ENTRANCE,
    CM_MAP_TRAINER_HILL_1F,
    CM_MAP_TRAINER_HILL_2F,
    CM_MAP_TRAINER_HILL_3F,
    CM_MAP_TRAINER_HILL_4F,
    CM_MAP_TRAINER_HILL_ROOF,
    CM_MAP_NAVEL_ROCK_EXTERIOR,
    CM_MAP_NAVEL_ROCK_HARBOR,
    CM_MAP_NAVEL_ROCK_ENTRANCE,
    CM_MAP_NAVEL_ROCK_B1F,
    CM_MAP_NAVEL_ROCK_FORK,
    CM_MAP_NAVEL_ROCK_UP1,
    CM_MAP_NAVEL_ROCK_UP2,
    CM_MAP_NAVEL_ROCK_UP3,
    CM_MAP_NAVEL_ROCK_UP4,
    CM_MAP_NAVEL_ROCK_TOP,
    CM_MAP_NAVEL_ROCK_DOWN01,
    CM_MAP_NAVEL_ROCK_DOWN02,
    CM_MAP_NAVEL_ROCK_DOWN03,
    CM_MAP_NAVEL_ROCK_DOWN04,
    CM_MAP_NAVEL_ROCK_DOWN05,
    CM_MAP_NAVEL_ROCK_DOWN06,
    CM_MAP_NAVEL_ROCK_DOWN07,
    CM_MAP_NAVEL_ROCK_DOWN08,
    CM_MAP_NAVEL_ROCK_DOWN09,
    CM_MAP_NAVEL_ROCK_DOWN10,
    CM_MAP_NAVEL_ROCK_DOWN11,
    CM_MAP_NAVEL_ROCK_BOTTOM,
    CM_MAP_TRAINER_HILL_ELEVATOR,
    CM_MAP_ROUTE104_PROTOTYPE,
    CM_MAP_ROUTE104_PROTOTYPE_PRETTY_PETAL_FLOWER_SHOP,
    CM_MAP_ROUTE109_SEASHORE_HOUSE,
    CM_MAP_ROUTE110_TRICK_HOUSE_ENTRANCE,
    CM_MAP_ROUTE110_TRICK_HOUSE_END,
    CM_MAP_ROUTE110_TRICK_HOUSE_CORRIDOR,
    CM_MAP_ROUTE110_TRICK_HOUSE_PUZZLE1,
    CM_MAP_ROUTE110_TRICK_HOUSE_PUZZLE2,
    CM_MAP_ROUTE110_TRICK_HOUSE_PUZZLE3,
    CM_MAP_ROUTE110_TRICK_HOUSE_PUZZLE4,
    CM_MAP_ROUTE110_TRICK_HOUSE_PUZZLE5,
    CM_MAP_ROUTE110_TRICK_HOUSE_PUZZLE6,
    CM_MAP_ROUTE110_TRICK_HOUSE_PUZZLE7,
    CM_MAP_ROUTE110_TRICK_HOUSE_PUZZLE8,
    CM_MAP_ROUTE110_SEASIDE_CYCLING_ROAD_NORTH_ENTRANCE,
    CM_MAP_ROUTE110_SEASIDE_CYCLING_ROAD_SOUTH_ENTRANCE,
    CM_MAP_ROUTE113_GLASS_WORKSHOP,
    CM_MAP_ROUTE123_BERRY_MASTERS_HOUSE,
    CM_MAP_ROUTE119_WEATHER_INSTITUTE_1F,
    CM_MAP_ROUTE119_WEATHER_INSTITUTE_2F,
    CM_MAP_ROUTE119_HOUSE,
    CM_MAP_ROUTE124_DIVING_TREASURE_HUNTERS_HOUSE,
};

#define MAP_GROUP_34_COUNT    0
#define MAP_GROUP_35_COUNT    0
#define MAP_GROUP_36_COUNT    0
#define MAP_GROUP_37_COUNT    0
#define MAP_GROUP_38_COUNT    0
#define MAP_GROUP_39_COUNT    0
#define MAP_GROUP_40_COUNT    0
#define MAP_GROUP_41_COUNT    0
#define MAP_GROUP_42_COUNT    0
#define MAP_GROUP_43_COUNT    0
#define MAP_GROUP_44_COUNT    0
#define MAP_GROUP_45_COUNT    0
#define MAP_GROUP_46_COUNT    0
#define MAP_GROUP_47_COUNT    0
#define MAP_GROUP_48_COUNT    0
#define MAP_GROUP_49_COUNT    0
#define MAP_GROUP_50_COUNT    0
#define MAP_GROUP_51_COUNT    0
